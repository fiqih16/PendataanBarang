                        ...
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <?php
                                    ...
                                    $data= mysqli_query($Conn, "SELECT * FROM passion");                                    
                                    while ($hasil = mysqli_fetch_array($data)) {
                                        $idps  = $hasil['idps'];
                                ?>
                                <tr>
                                    <td><?php echo $hasil['idps']?></td>
                                    ...
                                    <td>
                                        <button class="badge btn btn-warning" data-toggle="modal"
                                            data-target="#edit<?=$idps;?>">Edit</button>

                                        <button class="badge btn btn-danger" data-toggle="modal"
                                            data-target="#delete<?=$idps;?>">Hapus</button>
                                    </td>
                                </tr>

                                <!-- The Modal edit -->
                                <div class="modal fade" id="edit<?=$idps;?>">
                                    <div class="modal-dialog">
                                        <div class="modal-content">

                                            <!-- Modal Header -->
                                            <div class="modal-header">
                                                <h4 class="modal-title">Edit PTN Passion</h4>
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <input type="hidden" name="idps"
                                                        value="<?php echo $hasil['idps'] ?>">
                                                    <button type="submit" class="btn btn-primary"
                                                        name="updateptpassion">Submit</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
                                            ...
                                            <form method="post">
                                                <div class="modal-body">
                                                    ...
                                                    <button type="submit" class="btn btn-danger"
                                                        name="hapusptnpassion">Hapus</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
        ...
        <div class="modal-content">
            ...
            <form method="post">
                <div class="modal-body">
                    ...
                    <button type="submit" class="btn btn-primary" name="addptpassion">Submit</button>
                </div>
            </form>
